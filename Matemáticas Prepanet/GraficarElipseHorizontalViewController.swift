//
//  GraficarElipseHorizontalViewController.swift
...
class GraficarElipseHorizontalViewController: UIViewController {
    ...
    @IBAction func handleCalcular(_ sender: UIButton) {
        ...
        for i in -Int(valorA)..<Int(valorA)+1 {
        ...
        for i in 0..<valorx.count {
            valory.append((valorB * sqrt(pow(valorA, 2.0) - pow(valorH, 2.0) + (2.0*valorH*valorx[i]) - pow(valorx[i], 2.0)) / valorA) + valorK)
        }
        ...
        for i in 0..<valorx.count {
            valory2.append(valorK - (valorB * sqrt(pow(valorA, 2.0) - pow(valorH, 2.0) + (2.0*valorH*valorx[i]) - pow(valorx[i], 2.0)) / valorA))
        }
